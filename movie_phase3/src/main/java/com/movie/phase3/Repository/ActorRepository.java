...
public class ActorRepository implements actorjdbc {
    ...
    public void edit(Actor actor) {
        String sql = "update tblActors set actor_name=?, actor_gender=?, actor_age=?, actor_profile_image=?  Where actor_id=?";
        jdbc.update(sql,actor.getActor_name(), actor.getActor_gender(), actor.getActor_age(), actor.getActor_profile_image(), actor.getActor_id());
    }

    @Override
    public void delete(int id) {
        jdbc.update("delete  from tblActors where actor_id=?;", id);
